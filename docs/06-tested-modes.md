...
React on Rails Pro `17.1.0`, React on Rails RSC `19.3.0`, and
Shakapacker `10.2.0`.
...
- Historical Rspack/RSC manifest tracking lives in [shakacode/react_on_rails#1828](https://github.com/shakacode/react_on_rails/issues/1828). The starter requires `react-on-rails-rsc@19.3.0` or newer for the Rspack manifest path.
