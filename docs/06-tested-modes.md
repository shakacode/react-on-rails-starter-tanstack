...
React on Rails Pro `17.0.0-rc.12`, React on Rails RSC `19.2.1`, and
Shakapacker `10.2.0`.
Shakapacker remains on `10.2.0` because the React on Rails 17 RC12 upgrade did
...
- Historical Rspack/RSC manifest tracking lives in [shakacode/react_on_rails#1828](https://github.com/shakacode/react_on_rails/issues/1828). The starter requires `react-on-rails-rsc@19.2.1` or newer for the Rspack manifest path.
