...
This starter keeps the TanStack dashboard on Rspack and the current final stack:
React on Rails Pro `17.1.0-rc.5`, React on Rails RSC `19.3.0-rc.4`, and
Shakapacker `10.2.0`.
...
- Historical Rspack/RSC manifest tracking lives in [shakacode/react_on_rails#1828](https://github.com/shakacode/react_on_rails/issues/1828). The starter requires `react-on-rails-rsc@19.3.0-rc.4` or newer for the Rspack manifest path.
